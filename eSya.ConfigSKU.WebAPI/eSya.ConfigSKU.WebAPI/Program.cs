using eSya.ConfigSKU.WebAPI.Utility;
using eSya.ConfigSKU.WebAPI.Filters;
using Microsoft.Extensions.Configuration;
using DL_ConfigSKU = eSya.ConfigSKU.DL.Entities;
using eSya.ConfigSKU.IF;
using eSya.ConfigSKU.DL.Repository;
...
DL_ConfigSKU.eSyaEnterprise._connString = builder.Configuration.GetConnectionString("dbConn_eSyaEnterprise");
...
builder.Services.AddScoped<IItemControlRepository, ItemControlRepository>();
